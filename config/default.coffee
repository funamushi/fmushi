...
'''
    'tank':
      ...
      element: 'red'
      description: '''
知らない国での、何かとても大事な任務を遂行中、一人しかいない部下とはぐれてしまったので探しに来た。部下と一緒に戦車に乗った時の思い出が頭の上に乗っている。
'''
    'cloud':
      number: 4
      name: 'プヤプヤプンヤ一等兵'
      element: 'blue'
      description: '''
知らない国での、何かとても大事な任務を遂行中、雨が降っきたため、家に帰りたい気持ちになってしまった。かといって、任務を放り出すことはできず、どちらともつかない明後日の方向へ向かって歩いている。もう雨は止んだけど、雨の思い出が頭の上に乗っかっている。
'''
    'sakura':
      number: 5
      name: 'ポム家のこせがれ'
